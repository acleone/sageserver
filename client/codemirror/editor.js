...
var Editor = (function(){
  ...
  function Editor(codemirror) {
    ...
    if (options.height == 'dynamic') {
      select.scrollToCursor = function () {};
    }
  ...
  Editor.prototype = {
    ...
    keyDown: function(event) {
      ...
      var kd = this.options.keydown;
      if (kd) {
	event.data = kd.data;
        if (kd.func(event) === false) {
	    event.stop();
	    return false;
	}
      }
...
addEventHandler(window, "load", function() {
  ...
  var e = CodeMirror.editor = new Editor(CodeMirror);
